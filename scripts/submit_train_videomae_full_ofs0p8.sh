#!/bin/bash
#SBATCH --job-name=dtp-videomae-full-ofs0p8
#SBATCH --partition=courses-gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --cpus-per-task=4
#SBATCH --time=12:00:00
#SBATCH --output=logs/train_videomae_full_ofs0p8_%j.out
#SBATCH --error=logs/train_videomae_full_ofs0p8_%j.err
...
ANCHOR_OFFSET_SEC=${ANCHOR_OFFSET_SEC:-0.8}
