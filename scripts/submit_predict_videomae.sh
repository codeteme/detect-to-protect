#!/bin/bash
#SBATCH --job-name=dtp-videomae-predict
#SBATCH --partition=courses-gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=16G
#SBATCH --cpus-per-task=4
#SBATCH --time=02:00:00
#SBATCH --output=logs/predict_videomae_%j.out
#SBATCH --error=logs/predict_videomae_%j.err
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-outputs/best_videomae_clip${CLIP_LEN}_ofs${OFFSET_TAG}.pt}
