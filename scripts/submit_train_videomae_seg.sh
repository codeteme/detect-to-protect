#!/bin/bash
#SBATCH --job-name=dtp-videomae-seg-train
#SBATCH --partition=courses-gpu
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --cpus-per-task=4
#SBATCH --time=08:00:00
#SBATCH --output=logs/train_videomae_seg_%j.out
#SBATCH --error=logs/train_videomae_seg_%j.err
...
$PYTHON_BIN -u src/train_videomae_seg.py \
