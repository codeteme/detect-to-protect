...
| videomae-seg-ofs0.0 | rgb+seg | 0.0 | | outputs/best_videomae_seg_ofs0p0.pt | outputs/submission_videomae-seg-ofs0.0.csv | | |
| videomae-seg-ofs0.5 | rgb+seg | 0.5 | | outputs/best_videomae_seg_ofs0p5.pt | outputs/submission_videomae-seg-ofs0.5.csv | | |
| videomae-full-ofs0.0 | rgb+depth+seg | 0.0 | | outputs/best_videomae_full_ofs0p0.pt | outputs/submission_videomae-full-ofs0.0.csv | | |
| videomae-full-ofs0.5 | rgb+depth+seg | 0.5 | | outputs/best_videomae_full_ofs0p5.pt | outputs/submission_videomae-full-ofs0.5.csv | | |